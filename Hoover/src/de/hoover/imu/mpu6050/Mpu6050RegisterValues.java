...
public class Mpu6050RegisterValues {
	 ...
	 */
	public static final byte MPU6050_RA_GYRO_CONFIG_250 = 0b00000000;

	/**
	 * Sets the full scale range of the gyroscopes to ± 2000 °/s
	 */
	public static final byte MPU6050_RA_GYRO_CONFIG_2000 = 0b00011000;
	/**
	 ...
	 * <br>
	 * The concrete value 0 leaves the sample rate on default, which means 1kHz
	 * for acc-rate and 8kHz for gyr-rate.
	 */
	 ...
	 */
	public static final byte MPU6050_RA_ACCEL_CONFIG_2G = 0b00000000;
	/**
	 * Setting accelerometer sensitivity to ± 16g
	 */
	public static final byte MPU6050_RA_ACCEL_CONFIG_16G = 0b00011000;
	/**
	 ...
	 * FIFO
	 */
	public static final byte MPU6050_RA_FIFO = 0b01110000;
