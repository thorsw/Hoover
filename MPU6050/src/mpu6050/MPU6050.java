...
public class MPU6050 {
	...
	public MPU6050Data readingSensors() throws IOException {
		...
		int accX = gyro16(sensorData, 0);
		int accY = gyro16(sensorData, 2);
		int accZ = gyro16(sensorData, 4);

		int gyroX = gyro16(sensorData, 8);
		int gyroY = gyro16(sensorData, 10);
		int gyroZ = gyro16(sensorData, 12);
